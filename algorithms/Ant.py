...
class Ant:
    ...
    def draw(self, surface):
        ...
        for i, (trail_x,trail_y,alpha) in enumerate(reversed(self.trail)):
            ...
            fade_alpha = int(255 * (0.99 ** i))  # 0.97 controls fade rate
...
ants = [Ant(random.randint(1,360),center_of_screen_x,center_of_screen_y) for _ in range(50)]
